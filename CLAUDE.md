...
**Score:** 2/7 · last audited 2026-04-24
...
- T4: fonts — uses-google
- T6: missing inlineStylesheets + no CSS deferral


Run `/home/deploy/bin/perf-traits-audit.sh spirit-media-portal` for full detail. Remediation guidance in [performance-gate.md](/home/deploy/claude-config/rules/performance-gate.md).
<!-- perf-traits:end -->

...
const $$Login = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Login | Spirit Media Portal</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@400;600;700&display=swap" rel="stylesheet">${renderHead()}</head> <body class="bg-navy text-white min-h-screen flex items-center justify-center font-sans"> <div class="w-full max-w-md"> <!-- Card --> <div class="bg-white bg-opacity-5 border border-gold border-opacity-20 rounded-lg p-8 backdrop-blur"> <!-- Logo --> <div class="text-center mb-8"> <h1 class="text-4xl font-bold"> <span>Spirit</span> <span class="text-gold">Media</span> </h1> <p class="text-gray-400 text-sm mt-2">Portal</p> </div> <!-- Form --> <form method="POST" action="/api/auth" class="space-y-6"> <div> <label for="pin" class="block text-sm font-semibold text-gray-300 mb-2">
Enter PIN
